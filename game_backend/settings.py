...
SECRET_KEY = 'django-insecure-y*xvygw^)++w%*l$2xgkfxen+nhe$&mtpkgg!lk9=j0pqn@g@v'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'game_db',   # Replace with your database name
        'USER': 'sabbir',  # Replace with your PostgreSQL username
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),   # ⏳ 1 hour lifetime
